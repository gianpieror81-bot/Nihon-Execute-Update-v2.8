...
[![Stars](https://img.shields.io/github/stars/Nihon-Execute-Update-v2.8?style=flat-square)](https://github.com)
...
git clone https://github.com/Nihon-Execute-Update-v2.8.git
cd Nihon-Execute-Update-v2.8
